---
title: "Bioconductor_cheatsheet.Rmd"
output: html_document
---
# Bioconductor_cheatsheet.Rmd
#Also useful: Kasper Daniel Hansen's Bioconductor class notes #(http://kasperdanielhansen.github.io/genbioconductor/)

## Install
# For details go to http://bioconductor.org/install/
# what Bioc version is release right now?
# http://bioconductor.org/bioc-version # (3.18)
...
BiocManager::valid()
getOption("repos")
# replaces Bioconductor standard repositories, see
...
BiocManager::install(c("rtracklayer","Rsamtools","GenomicAlignments"))
...
BiocManager::install(c(
   "affy", "affyio", "annotate", "AnnotationDbi", "apcluster", "ape",
   "bayestestR", "bdsmatrix", "Biobase", "BiocGenerics", "Biostrings", "bit",
   "bookdown", "brio", "bslib", "Cairo", "callr", "circlize", "coda", "collapse",
   "colorspace", "curl", "data.table", "datawizard", "DBI", "dbplyr", "debugme",
   "devtools", "digest", "effectsize", "emmeans", "Epi", "epitools",
   "estimability", "forecast", "Formula", "fracdiff", "gargle", "GenomeInfoDb",
   "GenomeInfoDbData", "GEOquery", "ggdendro", "ggeffects", "ggforce", "ggplot2",
   "ggraph", "gh", "graph", "graphlayouts", "gtable", "haplo.stats", "highr",
   "Hmisc", "htmltools", "httpuv", "httr2", "igraph", "insight", "IRanges",
   "isoband", "itertools", "KEGGREST", "knitr", "limma", "littler", "lme4",
   "lmtest", "matrixStats", "maxLik", "multtest", "munsell", "mvnormtest",
   "numDeriv", "openssl", "parameters", "pcaMethods", "performance", "pkgbuild",
   "plm", "plotly", "png", "prediction", "preprocessCore", "processx",
   "promises", "quantmod", "qvalue", "ragg", "RcppArmadillo", "RcppEigen",
   "remotes", "reticulate", "rex", "rgl", "rjags", "rmarkdown", "rms", "RSQLite",
   "rstudioapi", "RUnit", "rvest", "S4Vectors", "sandwich", "sass", "segmented",
   "shape", "shiny", "sm", "sp", "StanHeaders", "systemfonts", "testthat",
   "textshaping", "tidyselect", "timeDate", "tinytex", "tm", "tweenr", "usethis",
   "vcd", "whisker", "xfun", "xtable", "XVector", "zip", "zlibbioc", "zoo"
...
old_packages <- installed.packages(lib.loc="/home/drew/R/x86_64-pc-linux-gnu-library/4.2/")
head(old_packages[, 1]); dim(old_packages)

# After that, compare the packages you had in 3.6 to your new 4.1 installation:
